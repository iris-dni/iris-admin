...
const removeValueFilter = (valueToRemove) => (value) => (
  valueToRemove !== value
);

const truthyFilter = (value) => !!value;
...
export default React.createClass({
  ...
  render() {
    ...
    const valueArray = this.props.value.split(',').filter(truthyFilter);
    ...
    return (
      <div>
        <Dropdown
          ...
          id={id}
          name="dropdown"
          options={[{ value: '', label: 'Add More...'}].concat(filteredOptions)}
          onValueChange={this.handleAddItem}
          value=""
        />
        <span>
          {
            valueArray.filter(uniqueFilter).map(value => {
