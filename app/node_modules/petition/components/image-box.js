...
const ImageShape = {
  ...
  data: React.PropTypes.shape({
    original_url: React.PropTypes.string.isRequired,
  }).isRequired,
};
...
const ImageTemplate = React.createClass({
  ...
  render() {
    ...
    const url = get(item, 'data.original_url');
    const isVisible = item.state === 'visible';
    ...
    const imageStyle = {
      marginBottom: 5,
      opacity: isVisible ? void 0 : 0.35,
    };

    return (
      <div className="text-center" style={containerStyle}>
        <Thumbnail src={url} style={imageStyle} />
        <Button
