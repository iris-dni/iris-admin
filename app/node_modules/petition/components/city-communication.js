    ...
    switch (name) {
      ...
      case 'generate-letter':
        return this.save().then(() => {
          setTimeout(() => this.props.router.push('/petition/' + this.props.petition.id + '/letter/cover'), 0);
        });
      case 'generate-appendix':
        return this.save().then(() => {
          setTimeout(() => this.props.router.push('/petition/' + this.props.petition.id + '/letter/appendix'), 0);
        });
      default:
