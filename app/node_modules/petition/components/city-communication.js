...
window.$__CityApi = CityAPI;


const PetitionShape = {
  city: React.PropTypes.any,
  city_answer: React.PropTypes.string,
...
export default React.createClass({
  ...
  componentWillMount() {
    this.fetchCity(this.props.petition.city);
  },

  componentWillReceiveProps(nextProps) {
    if (nextProps.petition.city !== this.props.petition.city) {
      this.fetchCity(nextProps.petition.city);
    }
  },
      ...
      case 'generate-appendix':
        return this.save().then(() => {
          setTimeout(() => {
            ...
            alert(`Feature "${name}" not yet available.`);
          }, 0);
        });
      default:
